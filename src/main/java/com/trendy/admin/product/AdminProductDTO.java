...
//     public AdminProductDTO(Long id, String brand, String name, int price, int likeCount) {
//     	this.id = id;
//         this.brand = brand;
//         this.name = name;
//         this.price = price;
...
//     public AdminProductDTO(Long id, String brand, String name, int price, String imageUrl, String modelId,int likeCount) {
//         this.id = id;
//         this.brand = brand;
//         this.name = name;
//         this.price = price;
...
//     public AdminProductDTO(Long id, String brand, String name, int price, String imageUrl, String imageDetailUrl1, String imageDetailUrl2, 
